...
public final class GeneralQueriesConstants implements Serializable{
	...
	public static final String GENERAL_QUERIES_ASSIGNMENT_USER_STATUS_COUNT = claimsResourceBundle.getString("medical.claim.general.queries.assignment.user.status.count");
