...
public final class ReimbursementQueriesConstants implements Serializable{
	...
	public static final String REIMBURSEMENT_QUERIES_CTDS_DETAILS_CARD_NO_CRITERIA = reimbursementResourceBundle.getString("reimbursement.queries.ctds.details.cardnumber.criteria");
	public static final String REIMBURSEMENT_QUERIES_CTDS_DETAILS_EMIRATES_CRITERIA = reimbursementResourceBundle.getString("reimbursement.queries.ctds.details.emiratesid.criteria");
	...
	public static final String REIMBURSEMENT_QUERIES_UPDATE_STATUS_CTDS_LEVEL_C = reimbursementResourceBundle.getString("reimbursement.queries.update.status.ctdslevelc");
	...
	public static final String REIMBURSEMENT_QUERIES_UPDATE_STATUS_CTDS_LEVEL_MC = reimbursementResourceBundle.getString("reimbursement.queries.update.status.ctdslevelmc");
	...
	public static final String REIMBURSEMENT_QUERIES_PROCESSING_DETAILS_FOR_ASSIGNMENT = reimbursementResourceBundle.getString("reimbursement.queries.processing.details.for.assignment");
	public static final String REIMBURSEMENT_QUERIES_PROCESSING_SERVICE_DETAILS = reimbursementResourceBundle.getString("reimbursement.queries.processing.service.details");
	...
	public static final String REIMBURSEMENT_QUERIES_UPDATE_CTDS_LEVEL_E = reimbursementResourceBundle.getString("reimbursement.queries.update.approve.ctdslevele");
	public static final String REIMBURSEMENT_QUERIES_CHECK_EXISTENCE_CTDS_LEVEL_E = reimbursementResourceBundle.getString("reimbursement.queries.check.existance.ctdslevele");
