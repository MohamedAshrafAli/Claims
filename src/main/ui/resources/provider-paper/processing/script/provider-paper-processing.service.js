(function() {
    ...
    angular
        .module('claims')
        .service('ProviderPaperProcessingService', ProviderPaperProcessingService)
    
    ProviderPaperProcessingService.$inject = [];
    function ProviderPaperProcessingService() {
        this.createNewProviderPaperObject = function() {
            return {
