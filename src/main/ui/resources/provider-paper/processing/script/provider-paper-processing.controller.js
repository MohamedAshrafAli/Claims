(function() {
    ...
    angular
        .module('claims')
            .controller('ProviderPaperProcessingController', ProviderPaperProcessingController);

        ProviderPaperProcessingController.$inject = ['$scope', '$rootScope', 'ProviderPaperProcessingService', 'ngNotify', '$timeout'];

        function ProviderPaperProcessingController($scope, $rootScope, ProviderPaperProcessingService, ngNotify, $timeout) {
            ...
            function init() {
                ...
                $scope.claim = ProviderPaperProcessingService.createNewProviderPaperObject();
                $scope.claimReqList = ProviderPaperProcessingService.getClaimsRequest();
                $scope.treatmentCodes = ProviderPaperProcessingService.getCodes('T');
                $scope.rejectionCodes = ProviderPaperProcessingService.getCodes('R');
                initGrid();
            ...
            $scope.createNewClaim = function() {
                $scope.createNew = true;
                $scope.claim = ProviderPaperProcessingService.createNewReimbursmentObject();
            }
            ...
            $scope.toggleJson = function(selectedClaim) {
                $scope.selectedClaim = ProviderPaperProcessingService.getClaimHeaderDetails(selectedClaim.reqNum);
                $scope.gridOptions.data = ProviderPaperProcessingService.getRequestDataForCalim(selectedClaim.reqNum);
            }
