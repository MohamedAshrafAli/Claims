    ...
    function PBMProcessingController($scope, $rootScope, PBMProcessingService, ngNotify) {
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                {name:'vatPercent', displayName:'VAT%', cellTemplate:'numberTemplate.html',width:115},
                {name:'vatAmount', displayName:'VAT Amount', cellTemplate:'numberTemplate.html',width:125},
