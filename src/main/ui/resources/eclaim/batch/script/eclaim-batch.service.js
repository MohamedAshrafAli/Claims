    ...
    function EclaimBatchService() {
        this.getSearchFields = function() {
            return [
                ...
                { label: 'Batch File Name', type: 'text', name: 'fileName',  width: '70%'},
                { label: 'Request Type', type: 'text', name: 'voucherNumber',  width: '80%'},
                { label: 'Received Date From', type: 'date', name: 'receivedFrmDate', width: '120%'},
                { label: 'Received Date To', type: 'date', name: 'receivedToDate', width:'110%'},
                // { label: 'Cheque Period From', type: 'date', name: 'chequeFrmPeriod', width: '90%'},
                // { label: 'Cheque Period To', type: 'date', name: 'chequeToPeriod', width: '90%'},
                // { label: 'Transaction Date From', type: 'date', name: 'transactionFrmDate', width: '90%'},
                // { label: 'Transaction Date To', type: 'date', name: 'transactionToDate', width: '90%'}
            ];
        }
        ...
        this.getRecordsFieldsInfo = function() {
            return [
                ...
                [
                    {label : 'Claims', name: 'claims', valueClass:"boldText"},
